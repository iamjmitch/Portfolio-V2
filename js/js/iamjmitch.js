...
const modalAndratech = document.getElementById('modalAndratech');
const modalAndratechBtn = document.getElementById('modalAndratechBtn');

const closeButton = document.getElementsByClassName('closeBtn');
var currentModal;
var currentClose;

modalAndratechBtn.addEventListener('click', function () {
  currentModal = modalAndratech;
  openModal();
});
